...
;Date:  <02/12/2020
;Class:  CMPE-250
;Section:  <01L1, Thursday, 2 - 3:50pm>
;---------------------------------------------------------------
...
;select MCGPLLCLK / 2 as UART0 clock source     
					...
					ORRS  R2,R2,R1    
					STR   R2,[R0,#0] ;Enable external connection for UART0     
					LDR   R0,=SIM_SOPT5     
					LDR   R1,=SIM_SOPT5_UART0_EXTERN_MASK_CLEAR     
					LDR   R2,[R0,#0]     
					BICS  R2,R2,R1    
					STR   R2,[R0,#0] ;Enable clock for UART0 module    
					LDR   R0,=SIM_SCGC4     
					LDR   R1,=SIM_SCGC4_UART0_MASK     
					LDR   R2,[R0,#0]     
					ORRS  R2,R2,R1    
					STR   R2,[R0,#0] ;Enable clock for Port A module     
					LDR   R0,=SIM_SCGC5     
					LDR   R1,=SIM_SCGC5_PORTA_MASK    
					LDR   R2,[R0,#0]     
					ORRS  R2,R2,R1    
					STR   R2,[R0,#0] ;Connect PORT A Pin 1 (PTA1) to UART0 Rx (J1 Pin 02)     
					LDR   R0,=PORTA_PCR1     
					LDR   R1,=PORT_PCR_SET_PTA1_UART0_RX     
					STR   R1,[R0,#0] ;Connect PORT A Pin 2 (PTA2) to UART0 Tx (J1 Pin 04)     
					LDR   R0,=PORTA_PCR2     
					...
					BICS  R2,R2,R1    
					STRB  R2,[R0,#UART0_C2_OFFSET] ;Set UART0 for 9600 baud, 8N1 protocol     
					...
					STRB  R1,[R0,#UART0_S2_OFFSET] ;Enable UART0 receiver and transmitter     
					MOVS  R1,#UART0_C2_T_R     
